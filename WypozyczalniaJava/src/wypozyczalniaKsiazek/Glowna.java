...
public class Glowna {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (wybor == 1) {
            ...
            String operacja;
            do {
                operacja = wyswietl("opcje: dodaj, wczytaj, wyswietl, wypozycz, zwrot, pokaż dostepne, wyjdz");
                ...
                } else if ("pokaż dostepne".equalsIgnoreCase(operacja)){
...
*/
    ...
    private static void wczytaj(Biblioteka biblioteka) throws IOException {
        System.out.println("Wczytano: ");
        FileReader fileReader = new FileReader("src/ksiazki.txt");
    ...
    private static void wczytajUzytkownika(BazaUzytkownikow bazaUzytkownikow) throws IOException {
        System.out.println("Wczytano: ");
        FileReader fileReader = new FileReader("src/uz.txt");
        BufferedReader bufferedReader = new BufferedReader(fileReader);
